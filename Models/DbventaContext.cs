...
//        => optionsBuilder.UseSqlServer("server=LTP-HP; database=DBVENTA; integrated security=true; User Id=sa; Password=prompt; TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Categoria>(entity =>
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C40A8907E");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F5D0961EC");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483FB5C77A7");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E1077418BAC1");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E2D35D220");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132FD700219");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F769EF02D68");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D8DF4ADC69");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE056FE5DE");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A66A95A9E4");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56140E3585DB");
